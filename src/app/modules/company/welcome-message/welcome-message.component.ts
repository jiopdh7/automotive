...
export class WelcomeMessageComponent implements OnInit {
  ...
  onCancelar() { 
    this.cRouter.navigateByUrl("/home/company")
  }
  ...
  onGuardarMensaje() {
    ...
    let oData = {
       ...
       masterUserId : this.oBrandModel.MasterUserId,
       externalId: this.oBrandModel.ExternalId, 
       isActived: this.oBrandModel.IsActived,
       isDeleted : false, 
       welcomeMessage:  this.c_mensaje.value,
       minDayCalendar: this.oBrandModel.MinDayCalendar
    };
    this.cCompanyService.MasterCompanyModify(oData).subscribe((oData) => { 
      let sMessage = '';
